...
class IPv6(Layer):
    ...
    def _parse(self, pkt: bytes):
        """
        Autogenerated by Github copilot.
        :param pkt:
        :return:
        """
        self.version = (pkt[0] >> 28) & 0x0f
        self.traffic_class = (pkt[0] >> 20) & 0x0ff
        self.flow_label = pkt[0] & 0x000fffff
        self.payload_length = struct.unpack("!H", pkt[1:3])[0]
        self.nextheader = pkt[3]
        self.hoplimit = pkt[4]
        self.psrc = bytesToIpv6(pkt[5:17])
        self.pdst = bytesToIpv6(pkt[17:29])
        self.data = pkt[29:]
